      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <h2 className="text-sm text-green-800 font-extrabold uppercase tracking-wide text-muted-foreground">
              About Us
            </h2>
          ...
          <div className="space-y-4 text-lg text-muted-foreground text-black">
            <p>
              Gizzia is a nutrition education platform designed for a wide range
              of people. Gizzia's goal is to provide a deep understanding of the
              importance of nutrition and a healthy lifestyle through
              comprehensive information. By using Gizza, users can learn about
              nutrition and share information with each other. In addition,
              users can also find out the level of health of users and identify
              the nutrition of a food more easily.
            </p>
          </div>
          <a href="/food-check" className="inline-block">
            <Button
              size="lg"
              className="bg-[#1B2E20] hover:bg-green-800 text-white px-8"
            >
              Food Check for Free
            </Button>
          </a>
